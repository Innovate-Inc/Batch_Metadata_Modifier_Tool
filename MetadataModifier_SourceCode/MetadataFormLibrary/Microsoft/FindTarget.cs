...
namespace Microsoft.Xml
{
    ...
    public interface IFindTarget {
        ...
        bool ReplaceCurrent(string searchValue, string replaceWith);

        //DS Added this here and in the class that inherits this interface
        /// <summary>
        /// Works similar to ReplaceCurrent however it replaces the current match with the unique file name. 
        /// </summary>
        /// <param name="searchValue"></param>
        /// <returns></returns>
        bool ReplaceCurrentwFileName(string searchValue);
